...
import { CreateTicketDto, UpdateTicketDto, AddTicketMessageDto, TicketFilterDto } from '../../admin/tickets/dto/ticket.dto';
...
@Controller('agency/support')
export class AgencySupportController {
  constructor(private readonly ticketsService: TicketsService) {}

  @Get()
  @ApiOperation({ summary: 'Tickets de suporte da agência' })
  ...
  @Patch(':id')
  update(@TenantId() agencyId: string, @Param('id') id: string, @Body() dto: UpdateTicketDto) {
    return this.ticketsService.update(id, dto, agencyId);
  }
